...
# Import and re-export fuzzer classes for backward compatibility
from scapy.contrib.automotive.uds_fuzzer import (  # noqa: E402, F401
    UDS_FuzzerEnumerator,
    UDS_AuthenticationFuzzerEnumerator,
