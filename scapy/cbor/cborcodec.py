...
class CBORcodec_Object(GenericCodecObject[_K], metaclass=CBORcodec_metaclass):
    ...
    # check_string is inherited from GenericCodecObject (uses _decoding_error_class)
    ...
    # dec is inherited from GenericCodecObject (uses _generic_error_classes and
    # _decoding_error_object_class)

    # safedec is inherited from GenericCodecObject
